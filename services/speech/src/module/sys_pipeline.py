...
from src.utils.common import save_txt
...
class SpeechSystem:
    ...
    def run(self) -> OutputSpeechSystemModel:
        try:
            ...
            output_file = '/speech/common_dir/output/output.txt'
            save_txt(file_name=output_file, content=speech_recognition)
            ...
            result = ResultSpeechSystemModel(generated_audio_file=output_file)
