...
class SpeechSystem:
    def __init__(self, inp: InputSpeechSystemModel):
        ...
        with ThreadPoolExecutor() as executor:
            ...
            future_speech_to_text = executor.submit(
                Speech2Txt, self.input_audio_file_path
            )
    ...
    def run(self) -> OutputSpeechSystemModel:
        try:
            ...
            logging.info(f'---------------------------{speech_recognition}')
            ...
            result = ResultSpeechSystemModel(generated_audio_file=None)
        ...
        return OutputSpeechSystemModel(
            input=self.input_audio_file_path,
            result=result,
            status=status
        )
